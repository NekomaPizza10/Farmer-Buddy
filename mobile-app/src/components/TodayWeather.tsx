    ...
    return (
        <View style={[styles.today, { width }]}>
            ...
            <View style={styles.locationParent}>
                ...
                <Text style={[styles.monday, styles.textTypo2]}>MONDAY</Text>
            ...
            <View style={[styles.parent, styles.parentLayout]}>
                <Text style={[styles.text13, styles.nowClr]}>30°</Text>
                <Text style={[styles.cloudy, styles.parentLayout]}>{`Cloudy `}</Text>
                <Text style={styles.h34L25}>
            ...
            <View style={styles.page}>
                <Text style={[styles.today2, styles.today2Typo]}>Today</Text>
                <Text style={[styles.tomorrow, styles.today2Typo]}>Tomorrow</Text>
            ...
            <View style={styles.topHeader}>
                ...
                <Image style={[styles.addIcon, styles.backLayout]} resizeMode="cover" />
            </View>
        </View>);
};
