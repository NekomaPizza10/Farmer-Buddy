			...
			<ScrollView style={styles.homePageInner} contentContainerStyle={{ height: 1050, paddingBottom: 40 }}>
				<View style={styles.weatherParent}>
					<Pressable style={styles.weather} onPress={() => { }}>
						...
						<Image style={[styles.maskGroupIcon, styles.kLayout]} source={require('assets/image/Locationicon.png')} resizeMode="cover" />
					...
					<Pressable style={[styles.sensorOff, styles.sensorLayout]} onPress={() => navigation.navigate('FarmerSensor' as never)}>
